...
public class ToBeDoneFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        view = inflater.inflate(R.layout.activity_tobedone_fragment, container, false);

        this.inflater = inflater;
        this.container = container;

        recyclerView = (RecyclerView) view.findViewById(R.id.tobedone_recyclerView);
    ...
    public void onStart() {
        ...
        gardenReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                tasksRecyclerViewAdapter = new TasksRecyclerViewAdapter("tobedone",getActivity(), task_list, gInfo);
